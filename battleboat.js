...
console.log("%cこのゲームをチェックしてくれてありがとん.%c  " +
	" Stats オブジェクトをハッキングして、Google Analytics を使用して情報を収集しています" +
	"ボットを改善するためにAIの勝敗率を計算するため " +
 "");
console.log("また、何かを試してみたい場合は、%csetDebug(true);%c を実行してください。 " +
	"何かをする前にコンソールを使用してください。いくつかの便利な機能にもアクセスできます。",
	"背景: #000; カラー: #0f0; パディング: 2px 5px; ボーダー半径: 2px;", "");
